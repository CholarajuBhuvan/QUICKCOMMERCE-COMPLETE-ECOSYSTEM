...
const OrdersPage = () => {
    ...
    const mockOrders = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Brown Rice', quantity: 1, price: 3.49 }
        ],
        totalAmount: 16.48,
        status: 'delivering',
      ...
      },
      {
        ...
        items: [
          { name: 'Orange Juice', quantity: 2, price: 8.98 },
          { name: 'Bread Loaf', quantity: 1, price: 2.99 }
        ],
        totalAmount: 11.97,
        status: 'delivered',
      ...
      },
      {
        ...
        items: [
          { name: 'Salmon Fillet', quantity: 1, price: 15.99 }
        ],
        totalAmount: 15.99,
        status: 'cancelled',
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'picking': return <FunnelIcon className="w-4 h-4" />;
